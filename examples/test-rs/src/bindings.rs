...
pub mod fermyon {
    ...
    pub mod spin_test_virt {
        ...
        pub mod http_handler {
            ...
            #[allow(unused_unsafe, clippy::all)]
            pub fn set_response(url: &str, response: FutureIncomingResponse) {
                unsafe {
                    let vec0 = url;
                    let ptr0 = vec0.as_ptr().cast::<u8>();
                    let len0 = vec0.len();
                    ...
                    #[cfg(target_arch = "wasm32")]
                    #[link(wasm_import_module = "fermyon:spin-test-virt/http-handler")]
                    extern "C" {
                    ...
                    wit_import(ptr0.cast_mut(), len0, (&response).take_handle() as i32);
                }
            }
        }
