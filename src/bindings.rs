...
#[allow(unused_unsafe, clippy::all)]
pub fn component_id() -> _rt::String {
    unsafe {
        #[repr(align(4))]
        struct RetArea([::core::mem::MaybeUninit<u8>; 8]);
        let mut ret_area = RetArea([::core::mem::MaybeUninit::uninit(); 8]);
        ...
        pub mod spin_test_virt {
            ...
            pub mod http_handler {
                ...
                pub unsafe fn _export_set_response_cabi<T: Guest>(
                    ...
                    let len0 = arg1;
                    let bytes0 = _rt::Vec::from_raw_parts(arg0.cast(), len0, len0);
                    T::set_response(_rt::string_lift(bytes0), super::super::super::super::wasi::http::types::FutureIncomingResponse::from_handle(arg2 as u32));
                }
                pub trait Guest {
                    fn set_response(url: _rt::String, response: FutureIncomingResponse);
                }
                #[doc(hidden)]
...
#[doc(hidden)]
pub static __WIT_BINDGEN_COMPONENT_TYPE: [u8; 7714] = *b"\
\0asm\x0d\0\x01\0\0\x19\x16wit-component-encoding\x04\0\x07\xa7;\x01A\x02\x01A\x20\
...
e\x01\x8c\x01\x03\x01\x15wasi:http/types@0.2.0\x05\x09\x01@\0\0s\x03\0\x08manife\
st\x01\x0a\x03\0\x0ccomponent-id\x01\x0a\x01B\x19\x04\0\x05store\x03\x01\x01q\x04\
\x10store-table-full\0\0\x0dno-such-store\0\0\x0daccess-denied\0\0\x05other\x01s\
\0\x04\0\x05error\x03\0\x01\x01i\0\x01j\x01\x03\x01\x02\x01@\x01\x05labels\0\x04\
\x04\0\x12[static]store.open\x01\x05\x01h\0\x01p}\x01k\x07\x01j\x01\x08\x01\x02\x01\
@\x02\x04self\x06\x03keys\0\x09\x04\0\x11[method]store.get\x01\x0a\x01j\0\x01\x02\
\x01@\x03\x04self\x06\x03keys\x05value\x07\0\x0b\x04\0\x11[method]store.set\x01\x0c\
\x01@\x02\x04self\x06\x03keys\0\x0b\x04\0\x14[method]store.delete\x01\x0d\x01j\x01\
\x7f\x01\x02\x01@\x02\x04self\x06\x03keys\0\x0e\x04\0\x14[method]store.exists\x01\
\x0f\x01ps\x01j\x01\x10\x01\x02\x01@\x01\x04self\x06\0\x11\x04\0\x16[method]stor\
e.get-keys\x01\x12\x04\x01\x1cfermyon:spin/key-value@2.0.0\x05\x0b\x01B\x1a\x01s\
...
\x05model\x0b\x04text\x15\0\x16\x04\0\x13generate-embeddings\x01\x17\x04\x01\x16\
fermyon:spin/llm@2.0.0\x05\x0c\x02\x03\0\x04\x10outgoing-request\x02\x03\0\x04\x0f\
request-options\x02\x03\0\x04\x18future-incoming-response\x02\x03\0\x04\x0aerror\
-code\x01B\x0f\x02\x03\x02\x01\x0d\x04\0\x10outgoing-request\x03\0\0\x02\x03\x02\
\x01\x0e\x04\0\x0frequest-options\x03\0\x02\x02\x03\x02\x01\x0f\x04\0\x18future-\
incoming-response\x03\0\x04\x02\x03\x02\x01\x10\x04\0\x0aerror-code\x03\0\x06\x01\
i\x01\x01i\x03\x01k\x09\x01i\x05\x01j\x01\x0b\x01\x07\x01@\x02\x07request\x08\x07\
options\x0a\0\x0c\x04\0\x06handle\x01\x0d\x04\x01\x20wasi:http/outgoing-handler@\
0.2.0\x05\x11\x01B\x05\x02\x03\x02\x01\x0f\x04\0\x18future-incoming-response\x03\
\0\0\x01i\x01\x01@\x02\x03urls\x08response\x02\x01\0\x04\0\x0cset-response\x01\x03\
\x04\x01#fermyon:spin-test-virt/http-handler\x05\x12\x01B\x11\x01r\x01\x03keys\x04\
...
set\x01\x0d\x04\x01&fermyon:spin-test-virt/key-value-calls\x05\x13\x04\x01\x1bfe\
rmyon:spin-test-virt/plug\x04\0\x0b\x0a\x01\0\x04plug\x03\0\0\0G\x09producers\x01\
