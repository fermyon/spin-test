...
// Options used:
pub type OutgoingResponse = wasi::http::types::OutgoingResponse;
pub type FutureIncomingResponse = wasi::http::types::FutureIncomingResponse;
...
#[allow(unused_unsafe, clippy::all)]
pub fn futurize_response(response: OutgoingResponse) -> FutureIncomingResponse {
    unsafe {
        #[cfg(target_arch = "wasm32")]
        #[link(wasm_import_module = "$root")]
        extern "C" {
            #[link_name = "futurize-response"]
        ...
        let ret = wit_import((&response).take_handle() as i32);
        wasi::http::types::FutureIncomingResponse::from_handle(ret as u32)
    }
}
#[doc(hidden)]
#[allow(non_snake_case)]
pub unsafe fn _export_set_component_id_cabi<T: Guest>(arg0: *mut u8, arg1: usize) {
    #[cfg(target_arch = "wasm32")]
    _rt::run_ctors_once();
    let len0 = arg1;
    let bytes0 = _rt::Vec::from_raw_parts(arg0.cast(), len0, len0);
    T::set_component_id(_rt::string_lift(bytes0));
}
pub trait Guest {
    /// Helper functions
    fn set_component_id(component_id: _rt::String);
}
#[doc(hidden)]

macro_rules! __export_world_env_cabi{
  ($ty:ident with_types_in $($path_to_types:tt)*) => (const _: () = {

    #[export_name = "set-component-id"]
    unsafe extern "C" fn export_set_component_id(arg0: *mut u8,arg1: usize,) {
      $($path_to_types)*::_export_set_component_id_cabi::<$ty>(arg0, arg1)
    }
  };);
}
#[doc(hidden)]
...
pub mod exports {
  ...
  ($ty:ident with_types_in $($path_to_types:tt)*) => (const _: () = {
    ...
    const _: () = {
      #[doc(hidden)]
      #[export_name = "fermyon:spin/key-value@2.0.0#[dtor]store"]
      #[allow(non_snake_case)]
        ...
        pub mod spin_test_virt {
            ...
            pub mod http_handler {
                ...
                pub type OutgoingResponse =
                    super::super::super::super::wasi::http::types::OutgoingResponse;
                #[doc(hidden)]
                #[allow(non_snake_case)]
                pub unsafe fn _export_set_response_cabi<T: Guest>(
                    ...
                    let len0 = arg1;
                    let bytes0 = _rt::Vec::from_raw_parts(arg0.cast(), len0, len0);
                    T::set_response(_rt::string_lift(bytes0), super::super::super::super::wasi::http::types::OutgoingResponse::from_handle(arg2 as u32));
                }
                pub trait Guest {
        ...
        pub mod http {
            ...
            pub mod outgoing_handler {
                ...
                pub type OutgoingRequest =
                    super::super::super::super::wasi::http::types::OutgoingRequest;
                pub type RequestOptions =
                    super::super::super::super::wasi::http::types::RequestOptions;
                pub type FutureIncomingResponse =
                    super::super::super::super::wasi::http::types::FutureIncomingResponse;
                ...
                pub unsafe fn _export_handle_cabi<T: Guest>(
                    ...
                    let result0 = T::handle(
                        super::super::super::super::wasi::http::types::OutgoingRequest::from_handle(
                            arg0 as u32,
                        ),
                        match arg1 {
                            0 => None,
                            1 => {
                                let e = super::super::super::super::wasi::http::types::RequestOptions::from_handle(arg2 as u32);
                                Some(e)
                            }
                            _ => _rt::invalid_enum_discriminant(),
                        },
                    ...
                    match result0 {
                        ...
                        Err(e) => {
                            *ptr1.add(0).cast::<u8>() = (1i32) as u8;
                            use super::super::super::super::wasi::http::types::ErrorCode as V17;
                            match e {
                                V17::DnsTimeout => {
                                ...
                                V17::DnsError(e) => {
                                    *ptr1.add(8).cast::<u8>() = (1i32) as u8;
                                    let super::super::super::super::wasi::http::types::DnsErrorPayload{ rcode:rcode2, info_code:info_code2, } = e;
                                    match rcode2 {
                                        Some(e) => {
                                ...
                                V17::TlsAlertReceived(e) => {
                                    *ptr1.add(8).cast::<u8>() = (14i32) as u8;
                                    let super::super::super::super::wasi::http::types::TlsAlertReceivedPayload{ alert_id:alert_id4, alert_message:alert_message4, } = e;
                                    match alert_id4 {
                                        Some(e) => {
                                            *ptr1.add(16).cast::<u8>() = (1i32) as u8;
                                ...
                                V17::HttpRequestHeaderSize(e) => {
                                    *ptr1.add(8).cast::<u8>() = (22i32) as u8;
                                    match e {
                                        Some(e) => {
                                            *ptr1.add(16).cast::<u8>() = (1i32) as u8;
                                            let super::super::super::super::wasi::http::types::FieldSizePayload{ field_name:field_name6, field_size:field_size6, } = e;
                                            match field_name6 {
                                                Some(e) => {
                                                    *ptr1.add(20).cast::<u8>() = (1i32) as u8;
                                                    let vec7 = (e.into_bytes()).into_boxed_slice();
                                ...
                                V17::HttpRequestTrailerSize(e) => {
                                    *ptr1.add(8).cast::<u8>() = (24i32) as u8;
                                    let super::super::super::super::wasi::http::types::FieldSizePayload{ field_name:field_name8, field_size:field_size8, } = e;
                                    match field_name8 {
                                        Some(e) => {
                                            *ptr1.add(16).cast::<u8>() = (1i32) as u8;
                                            let vec9 = (e.into_bytes()).into_boxed_slice();
                                ...
                                V17::HttpResponseHeaderSize(e) => {
                                    *ptr1.add(8).cast::<u8>() = (27i32) as u8;
                                    let super::super::super::super::wasi::http::types::FieldSizePayload{ field_name:field_name10, field_size:field_size10, } = e;
                                    match field_name10 {
                                        Some(e) => {
                                            *ptr1.add(16).cast::<u8>() = (1i32) as u8;
                                            let vec11 = (e.into_bytes()).into_boxed_slice();
                                ...
                                V17::HttpResponseTrailerSize(e) => {
                                    *ptr1.add(8).cast::<u8>() = (30i32) as u8;
                                    let super::super::super::super::wasi::http::types::FieldSizePayload{ field_name:field_name12, field_size:field_size12, } = e;
                                    match field_name12 {
                                        Some(e) => {
                                            *ptr1.add(16).cast::<u8>() = (1i32) as u8;
                                            let vec13 = (e.into_bytes()).into_boxed_slice();
                ...
                macro_rules! __export_wasi_http_outgoing_handler_0_2_0_cabi{
                                      ($ty:ident with_types_in $($path_to_types:tt)*) => (const _: () = {
                                        ...
                                        #[export_name = "wasi:http/outgoing-handler@0.2.0#handle"]
                                        unsafe extern "C" fn export_handle(arg0: i32,arg1: i32,arg2: i32,) -> *mut u8 {
                                          $($path_to_types)*::_export_handle_cabi::<$ty>(arg0, arg1, arg2)
                                        }
                                        #[export_name = "cabi_post_wasi:http/outgoing-handler@0.2.0#handle"]
...
macro_rules! __export_env_impl {
                              ($ty:ident) => (self::export!($ty with_types_in self););
                              ($ty:ident with_types_in $($path_to_types_root:tt)*) => (
                              $($path_to_types_root)*::__export_world_env_cabi!($ty with_types_in $($path_to_types_root)*);
...
#[doc(inline)]
pub(crate) use __export_env_impl as export;

#[cfg(target_arch = "wasm32")]
#[link_section = "component-type:wit-bindgen:0.24.0:env:encoded world"]
#[doc(hidden)]
pub static __WIT_BINDGEN_COMPONENT_TYPE: [u8; 11216] = *b"\
\0asm\x0d\0\x01\0\0\x19\x16wit-component-encoding\x04\0\x07\xd6V\x01A\x02\x01A>\x01\
...
\x01j\x01\x03\x01\x05\x01@\x03\x04self\x0a\x09statements\x06params\x0b\0\x0c\x04\
\0\x18[method]connection.query\x01\x0d\x01j\x01w\x01\x05\x01@\x03\x04self\x0a\x09\
statements\x06params\x0b\0\x0e\x04\0\x1a[method]connection.execute\x01\x0f\x04\x01\
\x1bfermyon:spin/postgres@2.0.0\x05\x1a\x01B\x0f\x01q\x04\x0finvalid-address\0\0\
\x14too-many-connections\0\0\x11connection-failed\x01s\0\x05other\x01s\0\x04\0\x05\
error\x03\0\0\x01m\x03\x0cat-most-once\x0dat-least-once\x0cexactly-once\x04\0\x03\
qos\x03\0\x02\x04\0\x0aconnection\x03\x01\x01p}\x04\0\x07payload\x03\0\x05\x01i\x04\
\x01j\x01\x07\x01\x01\x01@\x04\x07addresss\x08usernames\x08passwords\x1bkeep-ali\
ve-interval-in-secsw\0\x08\x04\0\x17[static]connection.open\x01\x09\x01h\x04\x01\
j\0\x01\x01\x01@\x04\x04self\x0a\x05topics\x07payload\x06\x03qos\x03\0\x0b\x04\0\
\x1a[method]connection.publish\x01\x0c\x04\x01\x17fermyon:spin/mqtt@2.0.0\x05\x1b\
\x01B\x13\x02\x03\x02\x01\x17\x04\0\x0fparameter-value\x03\0\0\x02\x03\x02\x01\x18\
\x04\0\x07row-set\x03\0\x02\x02\x03\x02\x01\x19\x04\0\x05error\x03\0\x04\x04\0\x0a\
...
\x01\x0d\x01j\0\x01\x05\x01@\x03\x04self\x0a\x09statements\x06params\x0b\0\x0e\x04\
\0\x1a[method]connection.execute\x01\x0f\x04\x01\x18fermyon:spin/mysql@2.0.0\x05\
\x1c\x01B\x15\x04\0\x0aconnection\x03\x01\x01q\x05\x10no-such-database\0\0\x0dac\
cess-denied\0\0\x12invalid-connection\0\0\x0ddatabase-full\0\0\x02io\x01s\0\x04\0\
\x05error\x03\0\x01\x01p}\x01q\x05\x07integer\x01x\0\x04real\x01u\0\x04text\x01s\
\0\x04blob\x01\x03\0\x04null\0\0\x04\0\x05value\x03\0\x04\x01p\x05\x01r\x01\x06v\
alues\x06\x04\0\x0arow-result\x03\0\x07\x01ps\x01p\x08\x01r\x02\x07columns\x09\x04\
...
]connection.execute\x01\x12\x04\x01\x19fermyon:spin/sqlite@2.0.0\x05\x1d\x01B\x05\
\x01q\x04\x0cinvalid-name\x01s\0\x09undefined\x01s\0\x08provider\x01s\0\x05other\
\x01s\0\x04\0\x05error\x03\0\0\x01j\x01s\x01\x01\x01@\x01\x04names\0\x02\x04\0\x03\
...
\x04\0\x04call\x03\0\x03\x01i\0\x01@\x01\x05labels\0\x05\x04\0\x12[static]store.\
open\x01\x06\x01h\0\x01@\x01\x04self\x07\0s\x04\0\x13[method]store.label\x01\x08\
\x01k\x01\x01@\x02\x04self\x07\x03keys\0\x09\x04\0\x11[method]store.get\x01\x0a\x01\
@\x03\x04self\x07\x03keys\x05value\x01\x01\0\x04\0\x11[method]store.set\x01\x0b\x01\
...
set-calls\x01\x11\x04\x01\x20fermyon:spin-test-virt/key-value\x05$\x02\x03\0\x0c\
\x05value\x02\x03\0\x0c\x0cquery-result\x02\x03\0\x0c\x05error\x01B\x0a\x02\x03\x02\
...
\x1dfermyon:spin-test-virt/sqlite\x05(\x04\x01\x1afermyon:spin-test-virt/env\x04\
